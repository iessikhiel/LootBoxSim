    ...
    public partial class asds : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChestDaoItemDao", x => new { x.ChestId, x.ItemsId });
                    table.ForeignKey(
                        name: "FK_ChestDaoItemDao_Chest_ChestId",
                        column: x => x.ChestId,
                        principalTable: "Chest",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChestDaoItemDao_Items_ItemsId",
                        column: x => x.ItemsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChestDaoItemDao_ItemsId",
                table: "ChestDaoItemDao",
                column: "ItemsId");
